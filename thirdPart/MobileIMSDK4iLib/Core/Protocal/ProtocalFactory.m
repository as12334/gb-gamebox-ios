...
/*
 * 一个将Protocal的数据内容对象转成JSON文本的内部方法.
 */
...
{
    // 该包当然不需要QoS支持！
//    return [Protocal initWithType:FROM_CLIENT_TYPE_OF_RECIVED content:recievedMessageFingerPrint from:from_user_id to:to_user_id];
