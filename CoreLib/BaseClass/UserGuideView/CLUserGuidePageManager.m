...
@interface _CLUserGuidePageCell : UICollectionViewCell

@property(nonatomic,strong,readonly) CLUserGuideView * pageView;

@end

//----------------------------------------------------------

@implementation _CLUserGuidePageCell
...
- (id)initWithCurrentPageView:(CLUserGuideView *)currentPageView andIndex:(NSUInteger)index;

- (void)startShowPageView:(CLUserGuideView *)pageView atIndex:(NSInteger)index bounces:(BOOL)bounces;
- (void)updateShowProgress:(CGFloat)progress;
- (void)completedShow;
- (void)cancleShow;

@property(nonatomic,strong,readonly) CLUserGuideView * currentPageView;
@property(nonatomic,strong,readonly) CLUserGuideView * targetShowPageView;
...
- (void)startShowPageView:(CLUserGuideView *)pageView atIndex:(NSInteger)index bounces:(BOOL)bounces
{
    ...
    if (!self.isTransiting) {
        ...
        CLUserGuideViewShowDirection direction = _targetShowPageIndex > _currentPageIndex ? CLUserGuideViewShowDirectionNext : CLUserGuideViewShowDirectionPrev;
...
@interface CLUserGuidePageManager () < UICollectionViewDataSource,
...
@implementation CLUserGuidePageManager
...
- (UICollectionView *)collectionView
{
    if (!_collectionView) {
        ...
        [_collectionView registerClass:[_CLUserGuidePageCell class]
...
{
    _CLUserGuidePageCell * cell = [collectionView dequeueReusableCellWithReuseIdentifier:defaultReuseDef
                                                                            forIndexPath:indexPath];

    CLCellContext * context = [[CLCellContext alloc] initWithIndexPath:indexPath
...
- (CLUserGuideView *)_userGuideViewAtIndex:(NSUInteger)index
{
    _CLUserGuidePageCell * cell = (id)[self.collectionView cellForItemAtIndexPath:[NSIndexPath indexPathForItem:index inSection:0]];
...
- (void)scrollViewDidScroll:(UIScrollView *)scrollView
{
    ...
    if (self.transitionContext.isTransiting) {
        ...
        if ([self _isVaildTargetPageIndex:desPageIndex]) {
            ...
            CLUserGuideView * userGuideView = [self _userGuideViewAtIndex:desPageIndex];
...
{
    id<CLUserGuidePageManagerDelegate> delegate = self.delegate;
...
- (CLUserGuideView *)userGuidePageView
{
    ...
    if ([userGuidePageViewClass isSubclassOfClass:[CLUserGuideView class]]) {
        return [userGuidePageViewClass createInstance];
    }
