...
@interface RH_LoginOCViewController ()<UITextFieldDelegate>
...
@implementation RH_LoginOCViewController
RH_LoginOCViewController * _shareLoginViewController = nil;
...
{
    id<RH_LoginOCViewControllerDelegate> delegate = self.delegate;
