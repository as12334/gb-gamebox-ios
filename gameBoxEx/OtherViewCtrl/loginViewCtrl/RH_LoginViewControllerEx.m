...
@interface RH_LoginViewControllerEx ()<UITextFieldDelegate>
...
RH_LoginViewControllerEx * _shareLoginViewController = nil;
...
{
    id<RH_LoginViewControllerExDelegate> delegate = self.delegate;
