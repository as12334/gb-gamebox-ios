...
@interface _CLBottomSwipeView : CLBorderView
...
@implementation _CLBottomSwipeView
{
...
- (id)initWithFrame:(CGRect)frame
{
    ...
    if (self) {
        ...
        self.borderMask = CLBorderMarkTop;
...
@interface CLDeclineMenuContainerView () <UIGestureRecognizerDelegate>

@property(nonatomic,strong,readonly) UIView * contentView;
@property(nonatomic,strong,readonly) _CLBottomSwipeView *bottomSwipeView;
...
@implementation CLDeclineMenuContainerView
...
- (CLBorderView *)bottomSwipeView
{
    if (!_bottomSwipeView) {
        _bottomSwipeView = [[_CLBottomSwipeView alloc] initWithFrame:CGRectMake(0.f, 0.f, CGRectGetWidth(self.bounds), BottomSwipeHeight)];
...
- (void)showWithView:(CLBasicDeclineMenuContentView *)declineMenuContentView animated:(BOOL)animated {
...
- (void)touchesBegan:(NSSet *)touches withEvent:(UIEvent *)event
{
    ...
    if (!CGRectContainsPoint(contentRect, touchPoint)) {
        ...
        if (bRet) { //询问代理
            id<CLDeclineMenuContainerViewDelegate> delegate = self.delegate;
...
@implementation UIView (CLDeclineMenuContainerView)

- (CLDeclineMenuContainerView *)declineMenuContainerView
{
    if ([self isKindOfClass:[CLDeclineMenuContainerView class]]) {
        return (id)self;
    }else {
