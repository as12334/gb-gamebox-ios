//
//  CLNavigationTransitioningDelegate.m
//  CoreLib
//
...
@implementation CLNavigationTransitioningDelegate
{
...
{
    CLBasicViewControllerAnimatedTransitioning * transitioning  = nil;
    ...
    switch (operation) {
        ...
        case UINavigationControllerOperationPush:
        {
            ...
            transitioning = transitioning ? : [[CLPushPopAnimatedTransitioning alloc] initWithType:PushPopAnimatedTypeNavigationPush];
        }
            break;
        ...
        case UINavigationControllerOperationPop:
        {
            ...
            transitioning = transitioning ? : [[CLPushPopAnimatedTransitioning alloc] initWithType:PushPopAnimatedTypeNavigationPop];
        }
...
- (CLNavigationTransitioningDelegate *)navigationTransitioningDelegate
{
    ...
    if (navigationController && [navigationController.delegate isKindOfClass:[CLNavigationTransitioningDelegate class]]) {
        return (CLNavigationTransitioningDelegate *)navigationController.delegate;
    }else{
