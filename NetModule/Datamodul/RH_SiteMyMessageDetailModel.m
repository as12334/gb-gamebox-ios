...
-(id)initWithInfoDic:(NSDictionary *)info
{
    if (self = [super initWithInfoDic:info])
    {
        ...
        _mAdvisoryTime = [NSDate dateWithTimeIntervalSince1970:[info floatValueForKey:RH_GP_MYMESSAGEDETAIL_ADVISORYTIME]/1000.0];
...
-(id)initWithInfoDic:(NSDictionary *)info
{
    if (self = [super initWithInfoDic:info]) {
        ...
        _mReplyTime = [NSDate dateWithTimeIntervalSince1970:[info floatValueForKey:RH_GP_MYMESSAGEDETAIL_REPLYTIME]/1000.0];
