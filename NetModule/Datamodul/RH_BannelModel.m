...
-(id)initWithInfoDic:(NSDictionary *)info
{
    ...
    if (self){
        ...
        _mEndTime = [NSDate dateWithTimeIntervalSince1970:[info floatValueForKey:RH_GP_Banner_ENDTIME]/1000.0] ;
        _mStartTime = [NSDate dateWithTimeIntervalSince1970:[info floatValueForKey:RH_GP_Banner_STARTTIME]/1000.0] ;
