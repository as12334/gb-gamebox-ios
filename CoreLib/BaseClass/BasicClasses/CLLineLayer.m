...
IMP_MUTATOR(setLineStyle:, CLLineStyle, _lineStyle, @selector(setNeedsLayout))
...
{
    if (self.lineStyle == CLLineStyleGradient) {
        [self setNeedsLayout];
    }
}
...
#define lineS 2 //倾斜的线
        ...
        if (self.lineStyle == CLLineStyleNormal) {
