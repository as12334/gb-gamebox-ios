...
-(void)setSendModel:(RH_SendMessageVerityModel *)sendModel
{
    ...
    if (sendModel.mIsOpenCaptcha==NO) {
        ...
        self.confimBtn.frame = CGRectMake(55, CGRectGetMaxY(self.backDropView.frame)+15, (screenSize().width-130)/2.0, 40);
        self.cancelBtn.frame = CGRectMake(CGRectGetMaxX(self.confimBtn.frame)+20, CGRectGetMaxY(self.backDropView.frame)+15, (screenSize().width-130)/2.0, 40);
    }
